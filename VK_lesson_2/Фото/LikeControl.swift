...
//  VK_lesson_2
//
//  Created by Чернецова Юлия on 21/01/2019.
...
private let width: CGFloat = 30.0
    ...
    private var likeView = UIView(frame: CGRect(origin: .zero, size: CGSize(width: 30.0, height: 30.0)))
    private var likeButtom = UIButton(type: .custom)
